...
| Implisit dari baseline candidate Q4_K_M | Frozen 1.200 | 86,0% | 100,0% | 93,0% | Behavioral 98,33%; implicit 93,33%; false execution 0/600; aktif di prototipe |

Angka baseline candidate dan kandidat implisit pada tabel telah dicocokkan dengan paket hasil lokal yang memuat metrics HF, metrics Q4, log, progress, manifest ekspor, dan ringkasan perbandingan HF-vs-Q4. Evaluasi Q4 keduanya dijalankan pada GPU NVIDIA L4 menggunakan format Q4_K_M. Model implisit dari baseline candidate kemudian dipasang pada prototipe setelah pemeriksaan service, health endpoint, dan smoke test lokal berhasil.

| Artifact kandidat Q4 | Jumlah frozen test | Ukuran artifact | Status |
| --- | ---: | ---: | --- |
| Baseline candidate | 800 | sekitar 505 MB | Evaluasi kanonik selesai; tersedia sebagai model cadangan |
| Implisit dari baseline candidate | 1.200 | sekitar 505 MB | Evaluasi kanonik selesai; aktif di prototipe sejak 19 Agustus 2026 |

!!! warning "Cara mengutip hasil"
    Jangan menggunakan angka HF-F16 untuk mengklaim performa Q4. Jangan memakai BERTScore sebagai pengganti keberhasilan tool call atau keselamatan aktuasi. Status aktif tetap perlu dibedakan dari hasil evaluasi offline dan uji fisik sistem.
